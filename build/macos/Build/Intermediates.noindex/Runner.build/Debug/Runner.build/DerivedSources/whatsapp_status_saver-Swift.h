...
#ifndef WHATSAPP_STATUS_SAVER_SWIFT_H
#define WHATSAPP_STATUS_SAVER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="whatsapp_status_saver",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21whatsapp_status_saver11AppDelegate")
...
SWIFT_CLASS("_TtC21whatsapp_status_saver17MainFlutterWindow")
