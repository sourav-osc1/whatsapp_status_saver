...
#ifndef STATUS_SAVER_SWIFT_H
#define STATUS_SAVER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="status_saver",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12status_saver11AppDelegate")
...
SWIFT_CLASS("_TtC12status_saver17MainFlutterWindow")
